...
export async function middleware(request: NextRequest) {
  ...
  // Allow public routes
  if (pathname.startsWith('/login') || pathname.startsWith('/register') || pathname.startsWith('/onboarding') || pathname.startsWith('/api/webhooks')) {
    return response
  }
  ...
  if (!tenantId && !pathname.startsWith('/super-admin') && !pathname.startsWith('/onboarding')) {
